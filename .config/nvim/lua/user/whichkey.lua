...
local mappings = {
  ...
  { "<leader>ff", "<cmd>lua require('telescope.builtin').find_files{ hidden=false}<cr>", desc = "Find files", nowait = true, remap = false },
  { "<leader>fF", "<cmd>lua require('telescope.builtin').find_files{ hidden=true}<cr>", desc = "Find files (+hidden)", nowait = true, remap = false },
